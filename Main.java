...
каждого массива и сообщите, для какого из массивов это значение оказалось больше (либо сообщите,
...
//            System.out.println();
//            for(int i = 0; i < massive.length; i++){
//                if(massive[i] >= max) {             // если неравенство строгое первый индекс максума
//                    max = massive[i];
//                    index = i;
//                }
//            }
...
//            }
//            System.out.println();
//            System.out.println("Quantity integer elements in the 3rd massive equals: " + j);
//    }
//}
...
либо сообщить, что эти суммы модулей равны. Если пользователь введёт неподходящее число, то программа должна требовать
...
//        //С помощиью операторов do-while мы запрашиваем пользователя ввести число большее 3, пока он с этим задание
//        // не справится
//        do{
